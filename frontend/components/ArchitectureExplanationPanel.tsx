...
export default function ArchitectureExplanationPanel({
  ...
  return (
    <div className="flex flex-col border border-white/5 rounded-2xl glass-panel p-5 h-full overflow-hidden">
      {/* Group Header */}
      ...
      {/* Sub-tabs Navigation */}
      <div className="flex border-b border-white/5 gap-1.5 py-2 mt-1">
        <button
          ...
          className={`px-3 py-1.5 rounded-lg text-[10px] font-mono transition-colors flex items-center gap-1 ${
            activeSubTab === "reasoning" ? "bg-indigo-500/20 text-indigo-300 border border-indigo-500/30" : "text-gray-400 hover:text-gray-200 border border-transparent"
          }`}
        >
        ...
        <button
          ...
          className={`px-3 py-1.5 rounded-lg text-[10px] font-mono transition-colors flex items-center gap-1 ${
            activeSubTab === "alternatives" ? "bg-indigo-500/20 text-indigo-300 border border-indigo-500/30" : "text-gray-400 hover:text-gray-200 border border-transparent"
          }`}
        >
        ...
        <button
          ...
          className={`px-3 py-1.5 rounded-lg text-[10px] font-mono transition-colors flex items-center gap-1 ${
            activeSubTab === "justification" ? "bg-indigo-500/20 text-indigo-300 border border-indigo-500/30" : "text-gray-400 hover:text-gray-200 border border-transparent"
          }`}
        >
      ...
      {/* Narrative block */}
      <div className="flex-1 overflow-y-auto max-h-56 mt-3 text-xs font-sans text-gray-300 leading-relaxed font-mono pr-1">
